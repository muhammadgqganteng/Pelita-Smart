    ...
    <div class="py-12">
        <div class="flex min-h-screen bg-gray-100">
            ...
            <aside class="w-20 bg-white shadow-md flex flex-col items-center py-4 space-y-6 rounded-r-xl">
                <!-- Sidebar Icons -->
                <a href="#"><img src="/images/svg/icon home.svg" class="w-10 h-10 ml-2" />beranda</a>
                <a href={{Route('jadwal.jadwal')}}><img src="/images/svg/icon jadwal.svg" class="w-10 h-10" />jadwal</a>
                <a href="#"><img src="/images/svg/mark.svg" class="w-10 h-10" />nilai</a>
                {{-- <a href={{Route('murid.kalender')}}><img src="/images/svg/buku.svg" class="w-10 h-10" />ebooks</a> --}}
                <a href={{Route('murid.kotak-saran.create')}} class="text-center"><img src="/images/svg/box.svg" class="w-10 h-10 ml-4" />kotak saran</a>
            </aside>
            ...
            <main class="flex-1 p-6 space-y-6 overflow-y-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div class="md:col-span-1 bg-white rounded-lg p-4 shadow">Ujian Terlaksana
                        <center>
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    <g>
                                        ...
                                        <g>
                                            ...
                                            <polygon fill="#F9EBB2" points="33,9.733 33,51.733 62,44 62,2 "></polygon>
                                        </g>
                    ...
                    <div class="md:col-span-1 bg-white rounded-lg p-4 shadow">Belum Terlaksana
                        <center>
                            <svg version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="md:col-span-1 bg-white rounded-lg p-4 shadow"><a href="{{Route('murid.ujian.index')}}">lihat ujian</a>
                        <center>
                            <svg height="116px" width="116px" version="1.1" id="Layer_1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                viewBox="-51.2 -51.2 614.40 614.40" xml:space="preserve" fill="#000000" class="mt-3">
