    ...
    <div class="py-12">
        <div class="flex min-h-screen bg-gray-100">
            ...
            <aside class="w-20 bg-white shadow-md flex flex-col items-center py-4 space-y-6 rounded-r-xl">
                ...
                <a href={{Route('guru.tugas.index')}}><img src="/images/svg/icon jadwal.svg" class="w-10 h-10" />buat tugas</a>
                <a href="#"><img src="/images/svg/mark.svg" class="w-10 h-10" />nilai</a>
                <a href={{Route('guru.ujian.index')}}><img src="/images/svg/box.svg" class="w-10 h-10" />test</a>
                {{-- <a href="{{ route('guru.ujian.soal.index', $ujian->id) }}"><img src="/images/svg/box.svg" class="w-10 h-10 ml-4" />   lihat</a> --}}
            </aside>
            ...
            <main class="flex-1 p-6 space-y-6 overflow-y-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="md:col-span-1 bg-white rounded-lg p-4 shadow"><a href="{{Route('jadwal.jadwal_ujian')}}">lihat ujian</a>
                        <center>
